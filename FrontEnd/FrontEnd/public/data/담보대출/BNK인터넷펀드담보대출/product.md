...
- **상품코드(FPCD)**: 0010400038
- **기준일자**: 2026-06-23
- **금리**: 최저 연 5.80% ~ 최고 연 6.50%
- **대출한도**: 5천만원(최저 10만원, 대출 당일 평가액의 50~90%까지)
- **대출기간**: ~ 5년(상환방식에 따라 다름)

## 상품개요

수익증권(펀드)을 담보로 필요할 때 방문없이 즉시신청

## 상품안내

### 상품개요

본인명의의 수익증권(펀드)를 담보로 영업점 방문 없이 인터넷상에서 필요할 때 즉시 대출을 받을 수 있는 인터넷 전용상품

### 대출조건(자격)

부산은행에서 본인명의의 수익증권(펀드)상품을 담보로 제공하고 대출을 받고자 하는 고객 (단, 미성년자, 외국인 및 법인은 제외)

### 대출한도

- 수익증권(펀드)의 대출 당일 평가금액의 최대 90%까지 가능합니다.
- 대출신청금액은 최저 10만원, 최고 5천만 원까지 이며, 10만원 단위로 신청 가능합니다.

### 상환방법 및 대출기간

- 일시상환: 1년 이내 (마이너스통장대출 포함)
- 원금균등 또는원리금균등 분할상환: 5년 이내
...
최저 연 5.71% ~ 최대 연 6.41% (신규취급액기준 COFIX : 2.81%, 2025.12.17 현재)
...
- [상품공시자료](https://www.busanbank.co.kr/SSPCTS/LN/3043/2/(2025.10.24)BNK인터넷펀드담보대출.pdf)