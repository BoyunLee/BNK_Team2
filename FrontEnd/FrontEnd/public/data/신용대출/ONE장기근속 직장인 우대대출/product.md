...
- **상품코드(FPCD)**: 0010400224
- **기준일자**: 2026-06-23
- **금리**: 최저 연 3.80% ~ 최고 연 12.50%
- **대출한도**: 200백만원
- **대출기간**: 6개월~10년
...
현 직장 60개월 이상 재직 중인 급여소득자로 상세 자격요건은 다음과 같음

| 직업체형태 | 법인기업체/일반기업체 |
| --- | --- |
| 재직기간 | 재직기간 60개월 이상 |
| 재직업체구분 | 일반기업체 |
| CB평점기준 | NICE 675점& KCB 625점 이상 |
| 연소득 | 30백만원 이상 |

### 대출한도

심사결과에 따라 최소 5백만원 ~ 최대 200백만원
...
※ 모바일 대출심사 시 공동인증서가 있는 스마트폰에서 공동인증서 비밀번호 입력으로 자동제출이 가능합니다.
...
※ 상기 적용금리에도 불구하고최저스프레드는 아래 미만으로 적용 불가

- 장기근속직장인(금리) : 기준금리 + 1.30%
- 장기근속직장인(한도) : 기준금리 + 2.10%

### 최종금리

최저 연 3.79% ~ 최고 12.49% (2026-05-28 신잔액기준 COFIX: 2.49%, 신규취급액기준 COFIX: 2.89%)
...
- [상품공시자료](https://www.busanbank.co.kr/SSPCTS/LN/3065/4/(2026.05.28)ONE장기근속직장인우대대출 공시자료.pdf)