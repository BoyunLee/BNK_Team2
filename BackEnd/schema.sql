...
CREATE TABLE IF NOT EXISTS ACCOUNT (
    ...
    account_type     VARCHAR(20)     NOT NULL DEFAULT 'DEPOSIT' COMMENT '계좌 종류 (DEPOSIT 입출금 / LOAN 대출)',
...
CREATE TABLE IF NOT EXISTS LOAN_CONTRACT (
    ...
    deposit_account_no VARCHAR(100) COMMENT '입금 계좌번호(입출금)',
    loan_deposit_account_no VARCHAR(100) COMMENT '실제 대출계좌번호 (ACCOUNT.account_no, LOAN 타입) — 실행 시 채번',
